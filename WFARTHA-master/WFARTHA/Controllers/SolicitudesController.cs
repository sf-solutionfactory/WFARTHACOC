...
namespace WFARTHA.Controllers
{
    ...
    public class SolicitudesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "NUM_DOC,NUM_PRE,TSOL_ID,TALL_ID,SOCIEDAD_ID,CANTIDAD_EV,USUARIOC_ID," +
            ...
            "DOCUMENTOCOC,EBELN,AMOR_ANT,RETPC,DPPCT,TOAD,ANTR,AMORANT, CUENTA_ID")] Models.DOCUMENTO_MOD doc, IEnumerable<HttpPostedFileBase> file_sopAnexar, string[] labels_desc, //MGC 26-12-2018 Factura y cuenta de pago
